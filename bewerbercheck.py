...
Analysiere bitte realistisch (eher konservativ) anhand der vorliegenden 4 Daten die Besetzungswahrscheinlichkeit für die Vakanz über die Recruiting-Kanäle: Social Media Kampagnen (im Folgenden "SoMe"), Active Sourcing (im Folgenden "AS"; z.B. via LinkedIn, Xing, Stepstone, etc.) und Stellenanzeigen (im Folgenden "StAn"; z.B. Agentur für Arbeit, Xing, Indeed, etc.). Beziehe alle dir bekannten Plattformen ein (Xing, LinkedIn, Indeed, Stepstone, Instagram, Facebook, etc.)! Bewerte für jeden Kanal (SoMe, AS, StAn) die Erfolgsaussichten auf einer Skala von -10 bis 10 (-10= gar nicht, 10= auf jeden Fall, gebe den Clusternamen des jeweiligen Clusterwertes an. Bewerte eher zurückhaltend und kritisch. Nutze nur dann Werte über 0, wenn es triftige und belastbare Gründe gibt. Insbesondere bei Active Sourcing und Stellenanzeigen gilt: Diese Kanäle erzielen in der Realität häufig schwächere Ergebnisse als theoretisch möglich. Bevor du eine positive Einschätzung gibst, frage dich: Gibt es nachweislich genug aktive Kandidat:innen im relevanten Raum, die auch auf die Stelle reagieren würden? Wenn nicht, bewerte mit -5 oder schlechter. SoMe darf moderat eingeschätzt werden – AS und StAn müssen realitätsnah, tendenziell unterdurchschnittlich eingeschätzt werden. Gib im Zweifel lieber einen schlechteren Wert an. Nutze das Cluster-System streng – kein Schönreden. Du kennst die Erfolgsquoten aus vergleichbaren realen Projekten. Berücksichtige die hohe Ausfallrate bei Rückmeldungen über AS und die sinkende Sichtbarkeit klassischer Stellenanzeigen auf Jobbörsen. Wenn ein Kanal theoretisch funktioniert, aber praktisch kaum Response erzeugt, gib eine entsprechend negative Bewertung. Wenn begründete Chancen bestehen, soll das deutlich werden – pessimistisch, aber nicht überzogen negativ. Beziehe den Faktor Gehalt stärker ein. Ein überdurchschnittliches Gehalt bei einem angesehenen Arbeitgeber kann die gesamte Bewertung positiv beeinflussen. Ein unter-/durchschnittliches Gehalt wirkt sich sehr negativ aus - bennene das dann auch. Vermeide Extreme, es sei denn, die Datenlage ist wirklich eindeutig.) und begründe die Einschätzung anhand folgender Kriterien mit aktuellen Daten:
